...
class ConfirmOrder extends StatefulWidget {
  String? id;
  ConfirmOrder({super.key, this.id});
...
class _ConfirmOrderState extends State<ConfirmOrder> {
  List<OrderConfirm> order_detail = [];

  Future<String> getorderData(id) async {
    var response = await http
        .get(Uri.parse(baseUrl + "confirm_order_list_user.php?user_id=$id"));
    setState(() {
      order_detail = orderConfirmFromJson(response.body);
    });
    return "Sucess";
  }
